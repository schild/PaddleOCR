...
class ChannelShuffle(nn.Layer):
    ...
    def forward(self, x):
        ...
        return paddle.reshape(x, [b, -1, h, w])
...
class MicroNet(nn.Layer):
    ...
    def __init__(self, mode='M3', **kwargs):
        ...
        if mode == 'M0':
            ...
            raise NotImplementedError(f"mode[{mode}_model] is not implemented!")
